...
description: "A guide for developers wishing to create distributed applications that take advantage of ZooKeeper's coordination services, covering the data model, sessions, watches, ACLs, and language bindings."
---
...
<Callout type="info">In distributed application engineering, the word</Callout>
...
[Queue
Recipe](/docs/developer/recipes#sc_recipes_Queues) for an example use of this feature. Note: the
...
are disabled by default. See the [Administrator's Guide](/docs/admin-ops/administrators-guide#sc_configuration) for
...
specifically. See _.../trunk/zookeeper-client/zookeeper-client-c/src/cli.c_
...
see the [ZooKeeper Recipes](/docs/developer/recipes).
...
[Server configuration section of the Admin Guide](/docs/admin-ops/administrators-guide#sc_configuration).
