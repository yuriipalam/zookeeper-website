...
export const pageTitle = `${CURRENT_VERSION} Overview`
export const pageDescription = `Official Apache ZooKeeper ${CURRENT_VERSION} documentation covering installation, configuration, the data model, client APIs, administration, and operations.`
