...
description: "This document is a guide for developers wishing to create"
---
...
<a id="Sequence+Nodes+--+Unique+Naming"></a>
...
<a id="sc_WatchPersistentRecursive"></a>
...
<a id="sc_ZooKeeperAccessControl"></a>
...
<a id="sc_ZooKeeperPluggableAuthentication"></a>
...
<a id="sc_java_client_configuration"></a>
...
<a id="Building+Your+Own+C+Client"></a>
...
* *[ZooKeeper Recipes](/docs/developer/recipes)* :
