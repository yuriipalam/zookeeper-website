...
- Apache Kafka relies on ZooKeeper for the following things: - **Controller election**
...
[^17]:
    TANG, C., KOOBURAT, T., VENKATACHALAM, P.,CHANDER, A., WEN, Z., NARAYANAN, A., DOWELL,P., AND KARL, R. Holistic Configuration Management
