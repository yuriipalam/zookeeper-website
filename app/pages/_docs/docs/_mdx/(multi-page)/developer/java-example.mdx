---
title: "ZooKeeper Java Example"
description: "To introduce you to the ZooKeeper Java API, we develop here a very simple"
---
...
is new in ZooKeeper 3.0.0). See [ZooKeeper Watches](/docs/developer/programmers-guide#ch_zkWatches)
