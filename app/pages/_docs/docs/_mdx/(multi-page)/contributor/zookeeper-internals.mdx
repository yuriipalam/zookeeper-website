...
description: "This document contains information on the inner workings of ZooKeeper."
---
...
<a id="sc_atomicBroadcast"></a>

## Atomic Broadcast

At the heart of ZooKeeper is an atomic messaging system that keeps all of the servers in sync.

<a id="sc_guaranteesPropertiesDefinitions"></a>
...
ZooKeeper, see the [Logging](/docs/admin-ops/administrators-guide#sc_logging) section
of the [ZooKeeper Administrator's Guide.](/docs/admin-ops/administrators-guide)

<a id="sc_developerGuidelines"></a>
