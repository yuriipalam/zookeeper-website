---
title: "ZooKeeper Dynamic Reconfiguration"
description: "Prior to the 3.5.0 release, the membership and all other configuration"
---
...
[reconfigEnabled](/docs/admin-ops/administrators-guide#sc_advancedConfiguration) configuration option.

<a id="ch_reconfig_format"></a>

## Changes to Configuration Format

<a id="sc_reconfig_clientport"></a>
...
<a id="sc_reconfig_standaloneEnabled"></a>
...
<a id="sc_reconfig_reconfigEnabled"></a>
...
measure are in place. So in 3.5.3 the [reconfigEnabled](/docs/admin-ops/administrators-guide#sc_advancedConfiguration) configuration option is introduced
...
<a id="sc_reconfig_access_control"></a>
...
they can set ["skipACL"](/docs/admin-ops/administrators-guide#sc_authOptions) to "yes" which will
...
* ***Disable ACL check*** :
    ZooKeeper supports ["skipACL"](/docs/admin-ops/administrators-guide#sc_authOptions) option such that ACL
```
...
<a id="sc_reconfig_incremental"></a>
...
<a id="sc_reconfig_nonincremental"></a>
...
<a id="sc_reconfig_conditional"></a>
...
<a id="ch_reconfig_rebalancing"></a>
