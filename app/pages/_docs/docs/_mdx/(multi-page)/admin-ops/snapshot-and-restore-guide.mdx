---
title: "ZooKeeper Snapshot and Restore Guide"
description: "Zookeeper is designed to withstand machine failures. A Zookeeper cluster can automatically recover"
---
