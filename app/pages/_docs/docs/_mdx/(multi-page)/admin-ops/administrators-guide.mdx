...
description: "This section contains information about deploying Zookeeper and"
---
...
[ZooKeeper Getting Started Guide](/docs/overview/getting-started)
...
7. If your configuration file is set up, you can start a
  ...
  The [ZooKeeper JMX
  document](/docs/admin-ops/jmx) contains details on managing ZooKeeper with JMX.
...
Running ZooKeeper in Single Server Mode](/docs/overview/getting-started#sc_InstallingSingleMode) section of the [ZooKeeper Getting Started
Guide](/docs/overview/getting-started).

For information on installing the client side libraries, refer to
the [Bindings](/docs/developer/programmers-guide#ch_bindings)
section of the [ZooKeeper
Programmer's Guide](/docs/developer/programmers-guide).

<a id="ch_administration"></a>
...
<a id="sc_CrossMachineRequirements"></a>
...
<a id="Single+Machine+Requirements"></a>
...
<a id="sc_provisioning"></a>

### Provisioning

<a id="sc_strengthsAndLimitations"></a>

### Things to Consider: ZooKeeper Strengths and Limitations

<a id="sc_administering"></a>

### Administering

<a id="sc_maintenance"></a>
...
<a id="Ongoing+Data+Directory+Cleanup"></a>
...
<a id="Debug+Log+Cleanup+Logback"></a>
...
* using the [`zkServer.sh status` command](/docs/admin-ops/zookeeper-tools#zkServer)
...
dynamic configuration file. See [Dynamic Reconfiguration](/docs/admin-ops/dynamic-reconfiguration) for more information.

<a id="sc_minimumConfiguration"></a>
...
<a id="sc_advancedConfiguration"></a>
...
* *extendedTypesEnabled* :
   (Java system property only: **zookeeper.extendedTypesEnabled**)
     **New in 3.5.4, 3.6.0:** Define to `true` to enable
     extended features such as the creation of [TTL Nodes](/docs/developer/programmers-guide#TTL+Nodes).
...
See the [ZooKeeper audit logs](/docs/admin-ops/audit-logs) for more information.
...
You will find an example [here](/docs/admin-ops/hierarchical-quorums)
...
[Programmers Guide](/docs/developer/programmers-guide#sc_java_client_configuration).
...
<a id="Experimental+Options%2FFeatures"></a>
...
<a id="Disabling+data+directory+autocreation"></a>
...
<a id="sc_db_existence_validation"></a>
...
<a id="sc_debug_observability_config"></a>
...
<a id="Communication+using+the+Netty+framework"></a>
...
<a id="Upgrading+existing+nonTLS+cluster"></a>
...
- Generating the **keystore.jks** and **truststore.jks** which can be found in the [Quorum TLS](/docs/admin-ops/administrators-guide#Quorum+TLS).
...
<a id="Recovery+-+TxnLogToolkit"></a>

#### Recovery - TxnLogToolkit
More details can be found in [this](/docs/admin-ops/zookeeper-tools#zkTxnLogToolkit)

<a id="sc_commonProblems"></a>
...
For multi-tenant installations see the [section](/docs/developer/programmers-guide#ch_zkSessions)
