---
title: "ZooKeeper-cli: the ZooKeeper command line interface"
description: "Enter into the ZooKeeper-cli"
---
...
Before using this cli,read the details in the [Dynamic Reconfiguration](/docs/admin-ops/dynamic-reconfiguration) about the reconfig feature,especially the "Security" part.
