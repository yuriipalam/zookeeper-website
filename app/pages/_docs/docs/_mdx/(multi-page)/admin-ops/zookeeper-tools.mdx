---
title: "A series of tools for ZooKeeper"
description: "A command for the operations for the ZooKeeper server."
---
...
### zkCli.sh
Look at the [ZooKeeperCLI](/docs/admin-ops/zookeeper-cli)
...
```
<a id="zkSnapshotRecursiveSummaryToolkit"></a>
...
#### Locate Snapshots
Snapshots can be found in [Zookeeper Data Directory](/docs/admin-ops/administrators-guide#The+Data+Directory) which configured in [conf/zoo.cfg](/docs/overview/getting-started#sc_InstallingSingleMode) when set up Zookeeper server. 
