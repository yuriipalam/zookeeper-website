...
<a id="getting-started-coordinating-distributed-applications-with-zooKeeper"></a>
...
<a id="sc_InstallingSingleMode"></a>
...
<a id="sc_ConnectingToZooKeeper"></a>
...
<Step>Create, inspect, update, and delete a test znode to validate end-to-end operation.</Step>
</Steps>
...
<a id="sc_ProgrammingToZooKeeper"></a>
...
<a id="sc_RunningReplicatedZooKeeper"></a>
