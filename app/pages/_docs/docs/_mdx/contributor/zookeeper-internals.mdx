...
description: "An in-depth look at ZooKeeper's inner workings: the atomic broadcast protocol (Zab), consistency guarantees, quorum mechanisms, and logging guidelines for contributors."
---

This document covers the inner workings of ZooKeeper, including the atomic broadcast
protocol, consistency guarantees, quorum design, and logging conventions.
...
the leader, the NEW\_LEADER proposal. (Hopefully you are thinking:
...
[Logging](/docs/admin-ops/administrators-guide#sc_logging) section of the
