---
title: "Oracle Quorum"
description: "Reference for configuring Oracle Quorum in ZooKeeper: oracle file format, zoo.cfg setup, liveness and safety trade-offs, and hardware/software failure detector implementation examples."
---
