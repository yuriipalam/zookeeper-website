---
title: "Oracle Quorum"
description: "How Oracle Quorum increases the availability of a two-instance ZooKeeper cluster by using a failure detector (the Oracle) to authorize a surviving instance to move forward without waiting for the faulty one."
---
...
When the Oracle satisfies the following property introduced by [CT]:
...
We consider the Oracle satisfies the following property introduced by [CT]:
