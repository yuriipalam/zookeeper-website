...
<Steps>
  ...
  <Step>
    ...
    from: [http://zookeeper.apache.org/releases.html](http://zookeeper.apache.org/releases.html)
  </Step>
  <Step>
...
```
    ...
    [Configuration Parameters](#sc_configuration). Every machine that is part of the ZooKeeper
    ...
    [specify multiple addresses](#id_multi_address) for each ZooKeeper server instance (this can
...
- _largeRequestMaxBytes_ :
  ...
  **New in 3.6.0:**
  The maximum number of bytes of all inflight large request. The connection will be closed if a coming large request causes the limit exceeded. The default is 100 _ 1024 _ 1024.
