...
<Callout type="warn">
  ...
  default and must be explicitly turned on via the
  [reconfigEnabled](/docs/admin-ops/administrators-guide/configuration-parameters#advanced-configuration)
...
[reconfigEnabled](/docs/admin-ops/administrators-guide/configuration-parameters#advanced-configuration) option was introduced in 3.5.3. Any attempt
...
[Specifying the Client Port](#changes-to-configuration-format). If a
...
[`skipACL`](/docs/admin-ops/administrators-guide/configuration-parameters#encryption-authentication-authorization-options) to `yes` skips
...
- **Disable ACL check:** ZooKeeper supports the
  [`skipACL`](/docs/admin-ops/administrators-guide/configuration-parameters#encryption-authentication-authorization-options) option such that
