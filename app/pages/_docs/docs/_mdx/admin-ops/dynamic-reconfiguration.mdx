...
<Callout type="warn">
  ...
  [reconfigEnabled](/docs/admin-ops/administrators-guide#sc_advancedConfiguration)
...
[reconfigEnabled](/docs/admin-ops/administrators-guide#sc_advancedConfiguration) option was introduced in 3.5.3. Any attempt
...
[`skipACL`](/docs/admin-ops/administrators-guide#sc_authOptions) to `yes` skips
...
- **Disable ACL check:** ZooKeeper supports the
  [`skipACL`](/docs/admin-ops/administrators-guide#sc_authOptions) option such that
