...
#### Locate Snapshots
Snapshots can be found in [Zookeeper Data Directory](/docs/admin-ops/administrators-guide#The+Data+Directory) which configured in [conf/zoo.cfg](/docs/overview/quick-start#sc_InstallingSingleMode) when set up Zookeeper server. 
