...
See [ZooKeeper CLI](/docs/admin-ops/zookeeper-cli).
...
Snapshots are stored in the [ZooKeeper data directory](/docs/admin-ops/administrators-guide#The+Data+Directory)
