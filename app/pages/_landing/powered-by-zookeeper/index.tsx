...
export function PoweredByZooKeeperPage() {
  return (
    <div className="container mx-auto mb-12 px-4 py-12">
      <article className="mx-auto">
        ...
        <p className="text-muted-foreground mb-8 text-center text-base leading-7">
          This page lists some institutions and projects which are using ZooKeeper. To have your
          organization added, file a documentation JIRA or email{" "}
          <a
            href="mailto:dev@zookeeper.apache.org"
        ...
        <p className="mb-12 text-center text-sm font-semibold">
          These items are user-submitted and the ZooKeeper team assumes no responsibility for their
          accuracy.
        </p>
